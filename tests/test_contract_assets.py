        ...
        "pages": [
            {
                **_identity(),
                ...
                "calibrationIds": ["CAL001"],
                "inheritedDesignRuleIds": [],
                "inconsistencyIds": [],
                "fixtureIds": ["FIX001"],
                "traceabilityIds": ["TR001"],
                "navigationSystemIds": ["NAV001"],
                "motionIds": [],
                ...
                "regions": [
                    {
                        ...
                        "dynamicMaskIds": [],
                        "antiAliasing": {"allowEnvironmentNoise": False, "rationale": None},
                        "textTolerance": {"maxShiftPx": 0, "fontRasterizationOnly": False},
                        "geometryTolerancePx": 0,
                        "materialChecks": ["background", "blur", "border", "shadow"],
        ...
        "references": [
            {
                ...
                "titleEvidence": {
                    ...
                    "transcription": {"zh-CN": "仪表盘", "en-US": "Dashboard"},
